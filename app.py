...
# Function to clean and tokenize words from SQL content
...
# Function to extract comments from SQL content
def extract_comments(sql_content):
    comments = re.findall(r'--.*?$|/\*.*?\*/', sql_content, re.S | re.M)
    return comments

# Function to extract variables and return values from SQL content
...
# Extract information from both SQL contents
...
# Function to extract mathematical formulae from SQL content
def extract_mathematical_formulae(sql_content):
    formulae = re.findall(r'[\w@]+\s*[\+\-\*/%]\s*[\w@]+', sql_content)
    return formulae

# Extract mathematical formulae from both SQL contents
...
# Function to find the maximum depth of nested SQL statements
